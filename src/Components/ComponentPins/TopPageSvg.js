...
import '../ComponentsCSS/TopPageSvg.scss';
...
const TopPageSvg = () => (
  ...
  >
    ...
    8Aq+vV+JwO51TDzMbuJe76tRjWpUoxrVqEY1Kj3+K8AAcZLXuc/2HcUAAAAASUVORK5CYII="
      ...
      <polyline className="st2" points="178.7,620.4 184.1,625.6 192.8,612.3" />
      <g>
        <defs>
    ...
    oxrVqEY1XBr/CDAAV1HClZwAOYUAAAAASUVORK5CYII="
      ...
      <polyline className="st2" points="178.7,620 184.1,625.2 192.8,611.9 " />
    </g>
  </svg>
