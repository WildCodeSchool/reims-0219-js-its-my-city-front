...
const PageBottomNextSvg = ({ dispatch }) => (
  ...
  >
    ...
    <g>
      <path
        className="st9"
        d="M158.6,41.6L158.6,41.6c0,14.9,11.8,26.8,26.5,26.8h0.4c14.6,0,26.5-12,26.5-26.8l0,0
            c0-14.9-11.8-26.8-26.5-26.8h-0.4C170.6,14.8,158.6,26.7,158.6,41.6z"
      />
      <g>
        <g>
          <g id="_x37__2_">
            <g>
              <path
                className="st1"
                d="M179.8,49.1c-0.4,0.3-0.4,0.8,0,1.1c0.4,0.3,1,0.3,1.5,0l12.1-8.6c0.2-0.1,0.3-0.3,0.3-0.5
                            c0-0.2-0.1-0.4-0.3-0.5L181.2,32c-0.4-0.3-1-0.3-1.5,0c-0.4,0.3-0.4,0.8,0,1.1l11.3,8L179.8,49.1z"
              />
            </g>
          </g>
        </g>
